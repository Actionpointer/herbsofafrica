                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="number" name="courses" value="{{$settings->firstWhere('name','courses')->value}}" placeholder="" class="form-control form-control-line" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Number of Students</label>
                                                <div class="col-md-12">
                                                    <input type="number" name="students" value="{{$settings->firstWhere('name','students')->value}}" placeholder="" class="form-control form-control-line" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Number of Instructors</label>
                                                <div class="col-md-12">
                                                    <input type="number" name="teachers" value="{{$settings->firstWhere('name','teachers')->value}}" placeholder="" class="form-control form-control-line" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Number of Countries</label>
                                                <div class="col-md-12">
                                                    <input type="number" name="countries" value="{{$settings->firstWhere('name','countries')->value}}" placeholder="" class="form-control form-control-line" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
