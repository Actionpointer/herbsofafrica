                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="excerpt" placeholder="Summary" rows="5" class="form-control" style="height: 100px">{{ old('excerpt') }}</textarea>
                                                    @error('excerpt')
                                                        <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{-- <div class="col-4">
                                                        <div class="form-group">
                                                            <label class="">Publish At</label>
                                                            <input id="datetimepicker" name="published_at" type="text" class="form-control datetimepicker" placeholder="Datetime Picker Here">
                                                        </div>
                                                    </div> --}}
...
@endsection
@push('scripts')
<script src="{{asset('plugins/datetime/moment.min.js')}}"></script>
