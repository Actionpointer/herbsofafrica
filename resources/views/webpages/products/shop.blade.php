...
<link rel='stylesheet' id='wd-widget-active-filters-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/woo-widget-active-filters.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
<link rel='stylesheet' id='wd-woo-shop-opt-shop-ajax-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/woo-shop-opt-shop-ajax.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
...
<link rel='stylesheet' id='wd-woo-mod-shop-loop-head-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/woo-mod-shop-loop-head.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
<link rel='stylesheet' id='wd-woo-shop-el-order-by-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/woo-shop-el-order-by.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
<link rel='stylesheet' id='wd-page-title-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/page-title.minc30a.css?ver=7.2.4')}}" type='text/css' media='all' />
<link rel='stylesheet' id='wd-off-canvas-sidebar-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/opt-off-canvas-sidebar.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
<link rel='stylesheet' id='wd-shop-filter-area-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/woo-shop-el-filters-area.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
...
<link rel='stylesheet' id='wd-categories-loop-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/woo-categories-loop-old.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
	
<link rel='stylesheet' id='wd-load-more-button-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/mod-load-more-button.minc30a.css?ver=7.2.4')}}" type='text/css'
		media='all' />
...
<link rel='stylesheet' id='wd-footer-base-css'
		href="{{asset('wp-content/themes/woodmart/css/parts/footer-base.minc30a.css?ver=7.2.4')}}" type='text/css' media='all' />
    ...
    <div class="page-title  page-title-default title-size-small title-design-centered color-scheme-light title-shop" style="">
        <div class="container">
            ...
            <h1 class="entry-title title">
                @if(Route::is('shop.category')) {{$shopCategory->title}} @else Shop @endif  
            </h1>
        </div>
    </div>
                    ...
                    <div id="woocommerce_product_categories-2"
                        ...
                        <ul class="product-categories">
                            ...
                            <li class="cat-item cat-item-39 @if(isset($shopCategory) && $shopCategory->id == $category->id) current-cat @endif">
                                <a href="{{route('shop.category',$category)}}">{{$category->title}}</a></li>
                            @endforeach 
                        </ul>
                    </div>
                </div><!-- .widget-area -->
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{asset('wp-content/themes/woodmart/js/scripts/wc/ajaxFilters.minc30a.js?ver=7.2.4')}}"
		id="wd-ajax-filters-js"></script>
	<script type="text/javascript" src="{{asset('wp-content/themes/woodmart/js/scripts/wc/sortByWidget.minc30a.js?ver=7.2.4')}}"
		id="wd-sort-by-widget-js"></script>
	<script type="text/javascript" src="{{asset('wp-content/themes/woodmart/js/scripts/wc/shopPageInit.minc30a.js?ver=7.2.4')}}"
		id="wd-shop-page-init-js"></script>
	<script type="text/javascript" id="wd-click-on-scroll-btn-js"
		src="{{asset('wp-content/themes/woodmart/js/scripts/global/clickOnScrollButton.minc30a.js?ver=7.2.4')}}"></script>
	...
	<script type="text/javascript" src="{{asset('wp-content/themes/woodmart/js/scripts/wc/filtersArea.minc30a.js?ver=7.2.4')}}"
		id="wd-filters-area-js"></script>
	<script type="text/javascript" src="{{asset('wp-content/themes/woodmart/js/scripts/wc/shopLoader.minc30a.js?ver=7.2.4')}}"
